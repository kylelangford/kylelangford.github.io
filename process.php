    ...
    <div class="panel article">
      <div class="wrap">
        <div class="squeeze">
            ...
            <h5>(to the designers)</h5>
            <p>The content building process is the time for you to understand your client and build trust by demonstrating your knowledge of your craft, their industry, their company and product. Another important goal here is to establish yourself as an authority. Letting the client hi-jack the creative process will see everyone lose. You will need this arsenal of information in order to make the most informed decisions and fight for what you believe (just be prepared to back it up). In the end you want to be a partner with your client as that is when the meaningful/good work happens. </p>
            ...
            <h4>Living Style Guide</h4>
            <p>This is just smart. Best not to ditch the kitchen sink. There are way out there to create living style guides. </p>

            <h4>Production Ready</h4>
            <p>Okay, so they love the site design and they can’t believe how much is already done. Even though we know there is still so much to do. At this point lets button up the front-end and get everything we can working. Depending on the project requirements you may have some back-end development working in tandem. If not probably time to get working on that. If you are one man gig I would hold off on that till last. </p>

            <h4>Theming / CMS Configuration</h4>
            <p>Okay, most likely this is not a static page. Whether this is an angular project, Drupal, Wordpress. It time to hook it up. Now I will say different platforms do impact the prototype and how I prep my code. I tend to work with Drupal so I am mostly thinking of that as I write this. But time to get a local install of your cams going. Normally there is a decent amount of configuration to build out the pages in Drupal. But, eventually it comes time to convert your static mock up into the theme template. Depending what you are working with this process can be vastly different. At the end of this phase you have a working site. </p>

            <h4>Back-end Development</h4>
            <p>Many times sites will need some custom development not offered by some module or plugin or for whatever reason you choose to do some custom work. If you are a lone wolf time to sink into some code. If you have some help time to add their work to the development site.  </p>

            <h4>Content</h4>
            <p>Time to put the client to work again. You and the client will need to upload all the content to the site and get that thing looking awesome. </p>
